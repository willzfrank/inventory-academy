...
type ValidateDocumentModalProps = {
  open: boolean;
  onClose: () => void;
  onConfirm: () => void;
};
    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      >
        ...
        <p className="mt-2 text-sm font-normal leading-5 text-[#667085]">
          You are about to validate this document. Please click Yes, Validate to proceed.
        </p>
